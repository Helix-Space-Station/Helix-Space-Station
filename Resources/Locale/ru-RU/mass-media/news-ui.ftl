...
news-comments-header = Комментарии
news-comments-empty = Комментариев пока нет
news-comment-placeholder = Написать комментарий...
news-comment-post-button = Отправить
news-comment-delete-button = Удалить
